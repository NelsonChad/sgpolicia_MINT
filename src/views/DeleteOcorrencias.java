 ...
 * @author DETEC_IT
 */
public class DeleteOcorrencias extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public DeleteOcorrencias(java.awt.Frame dialog, boolean modal) {
        super(dialog, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel6.setBorder(javax.swing.BorderFactory.createTitledBorder("eliminar"));
        ...
        jLabel4.setText("selecione uma ocorrencia e clike em Eliminar");

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/aki.gif"))); // NOI18N
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(btnEliminar, javax.swing.GroupLayout.PREFERRED_SIZE, 291, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeleteOcorrencias.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DeleteOcorrencias().setVisible(true);
            }
        });
    }
...
public void Descricao() {
    ...
    private void eliminar(){
        try {
            ...
            int op = jTablePesquisa.getSelectedRow();
            if (op == -1) {
                JOptionPane.showMessageDialog(null, "Selecione a ocorrencia que pretende eliminar!", "Aviso", JOptionPane.WARNING_MESSAGE);
                return;
            }
            if (jTablePesquisa.getSelectedRow() != -1) {
                ...
                opcao = JOptionPane.showOptionDialog(null, "Pretende realmente eliminar a ocorrencia selecionado?", "Confirmação", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, null, botoes, botoes[0]);

                if (opcao == JOptionPane.YES_OPTION) {
                    int[] linhas = jTablePesquisa.getSelectedRows();
                    for (int i = (linhas.length - 1); i >= 0; --i) {
                        String eliminar = "DELETE FROM Ocorrencia where cod_ocorrencia = ?";
                        ps = connect.conn.prepareStatement(eliminar);
                        
                        String indice = (String) jTablePesquisa.getModel().getValueAt(linhas[i], 0);
                        ps.setString(1, indice);
                        ps.executeUpdate();
                        ps.close();
                        
                       JOptionPane.showMessageDialog(null, "Ocorrencia eliminado com sucesso!", "Atencao", JOptionPane.WARNING_MESSAGE);  
                    }
                }

            }
        } catch (SQLException erro) {
            JOptionPane.showMessageDialog(null, "Erro ao eliminaar Ocorrencia !\nContacte o administrador do sistema."+erro+ "","Aviso", JOptionPane.ERROR_MESSAGE);
        }
    }
}
